					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-7 col-12">
							...
							<ul class="top-contact">
								...
								<li><i class="fa fa-envelope"></i><a href="mailto:support@yourmail.com">pelatihan@gmail.com</a></li>
							</ul>
							<!-- End Top Contact -->
						</div>
					</div>
							...
							<div class="col-12">
								<div class="single-main">
									...
									if ($result->num_rows > 0) {
										...
										echo "<img src='img/" . $row['foto'] . "' alt='', style= width:50% >";
									...
									<div class="blog-bottom">
										...
										<ul class="social-share">
											<li class="btn primary"><a href="<?= $row["link"]?>"><i class=""></i><span>Daftar Pelatihan</span></a></li>
